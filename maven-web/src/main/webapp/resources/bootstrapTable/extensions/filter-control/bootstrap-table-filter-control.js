    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        filterTemplate: {
            input: function (that, field, isVisible, placeholder) {
            	return ('<input type="text" class="form-control bootstrap-table-filter-control-name" style="width: 100%; visibility: visible" >');
            	//return  sprintf('<input type="text" class="form-control bootstrap-table-filter-control-%s" style="height:34px;width: 100%; visibility: %s" placeholder="%s">', field, isVisible, placeholder);
