...
(function($){ 	
	...
	var createGrips = function(t){	
		...
		th.each(function(i){				
			var c = $(this); 	
			c.css("width",widths[i]+5).removeAttr("width");
		});
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				minWidth: 20, 					//minimum width value in pixels allowed for a column 
