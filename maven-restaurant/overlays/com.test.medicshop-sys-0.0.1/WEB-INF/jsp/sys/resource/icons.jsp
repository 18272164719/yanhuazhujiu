...
<body class='iframebody'>
	<div class="tab-pane active" id="fa-icons">
		<section id="new">
			<h4 class="page-header">注：点击图标获取样式</h4>
		...
		<section id="web-application">
			<h4 class="page-header">Web com.test.Application Icons</h4>
			...
			<div class="row fontawesome-icon-list">
				...
				<div class="col-md-3 col-sm-4">
					<i class="fa fa-fw fa-star-half-empty"></i> fa-star-half-empty <span
						class="text-muted">(alias)</span>
				</div>
				<div class="col-md-3 col-sm-4">
...
<script>
$("#fa-icons").find("i").on("click",function(){
	top.callback($(this).attr("class"));
	h.bootboxHide();
});
</script>