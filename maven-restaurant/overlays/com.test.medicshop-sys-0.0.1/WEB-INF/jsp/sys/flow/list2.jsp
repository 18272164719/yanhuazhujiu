...
<body style='padding: 0px 15px;'>
	...
	<div id="toolbar" class="btn-group">
		...
		<button type="button" class="btn btn-default"   onclick=chooseObj()>
...
<script>
	...
	$(function() {
		...
		$('#table').bootstrapTable({
			...
			columns : [
			        {'radio':true,width :10},
					{field : 'workFlow.work.code',title : '流程编号',width : 120,align : 'left',editable:{
						type: 'text'
					}},
					{field : 'workFlow.work.name',title : '流程类型',width : 120,align : 'left',editable:{
						type: 'select',
						options:{
							data:"${pageContext.request.contextPath}/sys/organization/list.htmlx",
							params:{
								"query['t#orgType_I_EQ']" :1
							},
							width:"100%",
							valueField:"id",
							textField:"orgName"
